            ...
            currentRows.map((transaction, index) => (
              <tr key={`${transaction.id}-${startIndex + index}`}>
                ...
                <td>
                    <span
                        className={`statusDot ${
                        transaction.benchmark === "Fraudulent" ? "red" : "green"
                        }`}
                    ></span>
                ...
                <td>
                    <span
                        className={`statusDot ${
                        transaction.rfSmote === "Fraudulent" ? "red" : "green"
                        }`}
                    ></span>
                    {transaction.rfSmote}
                </td>
                ...
                <td>
                    <span
                        className={`statusDot ${
                        transaction.groundTruth === "Fraudulent" ? "red" : "green"
                        }`}
                    ></span>
                ...
                <td>
                    <span className="riskBadge blueBadge">
                        {transaction.risk1}
                    </span>
                    <span className="riskBadge purpleBadge">
                        {transaction.risk2}
                    </span>
                </td>
